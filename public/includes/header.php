    ...
    <div class="header-top">
        ...
        <div class="header-right">
            ...
            <button class="btn-idioma">
                <img src="/iconos/language.svg" alt="Idioma" class="icono-idioma" />
            </button>
            <?php if (isset($_SESSION['user_id'])): ?>
                <button class="btn-login" data-url="/auth/profile.php">Perfil</button>
            <?php else: ?>
                <button class="btn-login" data-url="/auth/login.php">Login</button>
            <?php endif; ?>
            <button class="btn-carrito">
                <img src="/iconos/shopping_cart.svg" alt="Carrito" class="icono-carrito" />
            </button>
        </div>
    </div>
    ...
    <div class="header-bottom">
        <div class="menu-col">
            <button class="menu-btn">
                <img src="/iconos/menu.svg" alt="" class="menu-icon-left" />
                <span class="menu-text">Accesorios</span>
                <img src="/iconos/arrowDown.svg" alt="" class="menu-icon-right" />
            </button>
            <ul class="submenu">
        ...
        <div class="buscador-container">
            <div class="buscador-wrapper">
                ...
                <button class="buscador-btn">
                    <img src="/iconos/lupa.svg" alt="Buscar" class="lupa-icon" />
                </button>
            </div>
        </div>
    </div>
